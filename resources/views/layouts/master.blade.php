...
<body class="hold-transition sidebar-mini">
    <div class="wrapper" id="app">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4" style="z-index: 11000">
            <!-- Brand Logo -->
            <a href="/dashboard" class="brand-link">
                <img src="{{ URL::asset('img/AdminLTELogo.png') }}" alt="DepEd Logo"
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        ...
                        @elseif(Auth::user()->photo)
                            <img src="{{ URL::asset('img/'.Auth::user()->photo) }}" class="img-circle elevation-2"
                                alt="User Image" />
                        @else
